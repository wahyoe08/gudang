...
<?php 
	...
	$count_query   = mysql_query("SELECT COUNT(data_perencanaan.id_rencana) AS numrows FROM data_perencanaan LEFT JOIN data_barang ON data_perencanaan.part_number = data_barang.part_number");
	...
	$query = mysql_query("SELECT data_barang.part_name, data_barang.supplier, data_barang.part_number, data_perencanaan.*
	FROM data_perencanaan LEFT JOIN data_barang ON data_perencanaan.part_number = data_barang.part_number GROUP BY data_perencanaan.id_rencana LIMIT $offset,$per_hal");
