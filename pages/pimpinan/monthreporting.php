	...
	if(isset($_POST['submit']))
{
	...
	FROM barang_".$_POST['lp']." LEFT JOIN data_barang ON barang_".$_POST['lp'].".part_number = data_barang.part_number  Where tgl BETWEEN '".$_POST['tglr']."' AND '".$_POST['tglr2']."' GROUP BY ID_".$_POST['lp']."");
	...
	$query=mysql_query("SELECT barang_".$_POST['lp'].".tgl, barang_".$_POST['lp'].".part_number, data_barang.part_number, data_barang.part_name, data_barang.satuan, barang_".$_POST['lp'].".jumlah
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <td width="11%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="17%">Export To <img src="img/excel.ico" border="1" width="32" height="32" onClick="window.open('<?php echo $baseurl."pages/web/export-excel-excel.php?tgl1=".$_POST['tglr']."&tgl2=".$_POST['tglr2']."&field=".$_POST['lp']; ?>','popuppage','width=500,toolbar=0,resizable=0,scrollbars=no,height=400,top=100,left=100');" /></td>
