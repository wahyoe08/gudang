...
<h2>Laporan Bahan Baku Masuk dan Keluar</h2>
<form name="form1" method="post" action="">

Laporan 
    <select name="lp" id="lp">
	<option value="masuk">Bahan Baku Masuk</option>
	<option value="keluar">Bahan Baku Keluar</option>
    </select>
	Cari tanggal
	...
	if(isset($_POST['submit']))
{
	...
	FROM barang_".$_POST['lp']." LEFT JOIN data_barang ON barang_".$_POST['lp'].".part_number = data_barang.part_number  Where tgl BETWEEN '".$_POST['tglr']."' AND '".$_POST['tglr2']."' GROUP BY ID_".$_POST['lp']." LIMIT $offset,$per_hal");
	$count_query2   = mysql_query("SELECT COUNT(ID_".$_POST['lp'].") AS numrows FROM barang_".$_POST['lp']." Where tgl BETWEEN '".$_POST['tglr']."' AND '".$_POST['tglr2']."' GROUP BY ID_".$_POST['lp']." LIMIT $offset,$per_hal");
	...
	$query=mysql_query("SELECT barang_".$_POST['lp'].".tgl, barang_".$_POST['lp'].".part_number, data_barang.part_number, data_barang.part_name, data_barang.harga, data_barang.satuan, barang_".$_POST['lp'].".no_po, barang_".$_POST['lp'].".jumlah_order, barang_".$_POST['lp'].".jumlah, barang_".$_POST['lp'].".jumlah
	FROM barang_".$_POST['lp']." LEFT JOIN data_barang ON barang_".$_POST['lp'].".part_number = data_barang.part_number  Where tgl BETWEEN '".$_POST['tglr']."' AND '".$_POST['tglr2']."' GROUP BY ID_".$_POST['lp']." LIMIT $offset,$per_hal");
?>
<?php
if($numrows > 0 )
    ...
    <td width="11%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="17%">Export To <img src="img/excel.ico" border="1" width="32" height="32" onClick="window.open('<?php echo $baseurl."pages/web/export-excel-barang.php?tgl1=".$_POST['tglr']."&tgl2=".$_POST['tglr2']."&field=".$_POST['lp']; ?>','popuppage','width=500,toolbar=0,resizable=0,scrollbars=no,height=400,top=100,left=100');" /></td>
         <td width="17%">Export To <img src="img/pdf.ico" border="1" width="32" height="32" onClick="window.open('<?php echo $baseurl."pages/web/mpdf.php?tgl1=".$_POST['tglr']."&tgl2=".$_POST['tglr2']."&field=".$_POST['lp']; ?>','popuppage','width=500,toolbar=0,resizable=0,scrollbars=no,height=400,top=100,left=100');" /></td>
      </tr>
    </table></td>
  </tr>
</table>
